...
- [ ] **BRAND-01**: Site header and footer display the official AMR logo (AMR Logo_Feb2026.jpeg — Africa map silhouette + "AntiMicrobial Resistance" wordmark)
- [ ] **BRAND-02**: Site color palette is updated from Navy/Teal to AMR brand colors (Emerald Green, Gold, Slate Grey — derived from logo; exact values confirmed at plan phase)
